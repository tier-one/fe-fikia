...
export default function Contact() {
  ...
  return (
    <main className='pt-16'>
      ...
      <section className="flex justify-center items-center lg:mx-32 xl:mx-48  md:mx-4 bg-cover bg-center rounded-xl mb-16" style={{ backgroundImage: "url('/contact.svg')", height: '400px', }}>
        <div className="border border-white flex flex-col rounded-xl mx-8 p-4" style={{
          ...
          <p className="text-1xl font-semibold text-white mt-3">Frankie Sylvester</p>
