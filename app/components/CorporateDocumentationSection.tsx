...
const CorporateDocumentationSection = ({ handleContinue, handleBack, visible }: Props) => {
    const formik = useFormik({
      ...
      validationSchema: Yup.object({
        image: Yup.string()
          .required("Your Corporate license is required"),
      }),
    ...
    return (
        <div className="flex px-[50px] flex-col items-center pt-[105px] lg:pr-[98px] pb-[140px] lg:pl-[106px] flex-1 self-stretch bg-[#FFF]">
          <div className="flex flex-col items-start gap-[48px] w-full">
            ...
            <p className="text-[#4D5E80] text-[15px] font-[400] leading-[28px]">
              Upload RDB certificate of registration for verification
            </p>
...
export default CorporateDocumentationSection